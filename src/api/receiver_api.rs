...
pub fn decode_message(data: &[u8]) -> Result<RithmicResponse, Box<RithmicResponse>> {
    ...
    let response = match parsed_message.template_id {
        // Shared
        10 => { // RequestLogin (Should not receive this usually)
        ...
        17 => {
            ...
            RithmicResponse {
                ...
                is_update: false, multi_response: true,
            }
        },
        19 => {
        ...
        118 => {
            ...
            RithmicResponse {
                ...
                is_update: false, has_more: false, multi_response: true,
            }
        },
        120 => {
        ...
        250 => {
             ...
             RithmicResponse {
                 ...
                 is_update: false, has_more: false, multi_response: false, error: None,
             }
        },
        251 => {
        ...
        505 => { // AcceptAgreement Response (Wait, template name?)
...
fn get_error(rp_code: &[String]) -> Option<String> {
    if (rp_code.len() == 1 && rp_code[0] == "0") || (rp_code.is_empty()) {
        ...
        Some(rp_code.get(1).cloned().unwrap_or_else(|| "Unknown Error".to_string()))
    }
}
